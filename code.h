...
public:
	...
	// Parameter n is the length of the code, and m is the range 
	// of each digit (0 to m-1).
	// Values n and m are assumed to be negative.

	Code(int n = 0, int m = 0);


	// Constructor: initializes the code directly from a given vector.
	...
	// Returns the number of digits that are matches and in the correct
	// position when compared with the guess.
	// Parameter guess is a const reference to another Code object 
	// to compare against.
